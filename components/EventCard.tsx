  ...
  const renderQueuePosition = () => {
    ...
    return (
      <div className="flex items-center justify-between p-3 bg-blue-50 rounded-lg border border-blue-100">
        <div className="flex items-center">
          <LoaderCircle className="size-5 text-blue-500 mr-2 animate-spin" />
          <span className="text-blue-700">Queue Position</span>
        </div>
        <span className="text-blue-700 rounded-full px-3 py-1 bg-blue-100 font-medium">
          #{queuePosition.position}
        </span>
      </div>
    );
      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        <div className="flex justify-between items-start">
          <div>
            ...
            {isPastEvent && (
              <span className="inline-flex items-center bg-gray-100 text-gray-800 mt-1 px-2.5 py-0.5 rounded-full text-xs font-medium">
                Past Event
              </span>
            )}
          </div>
